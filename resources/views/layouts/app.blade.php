...
<head>
    ...
    <style>
        ...
        @media (min-width: 1024px) { 
            .hover-dropdown:hover .dropdown-panel { display:block; } 
        }
        ...
        [data-theme="dark"] .theme-icon.sun { opacity: 0; transform: rotate(180deg); }
        [data-theme="dark"] .theme-icon.moon { opacity: 1; transform: rotate(0deg); }
        [data-theme="light"] .theme-icon.sun, :root .theme-icon.sun { opacity: 1; transform: rotate(0deg); }
        [data-theme="light"] .theme-icon.moon, :root .theme-icon.moon { opacity: 0; transform: rotate(-180deg); }
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button id="theme-toggle" class="theme-toggle relative rounded-full theme-border border theme-bg-primary p-2.5 theme-text-secondary hover:theme-bg-tertiary focus-ring" aria-label="Toggle theme">
                        ...
                        <i class="fa-solid fa-sun opacity-0"></i> <!-- Spacer -->
                    </button>
                    ...
                    @guest
                        <a href="{{ route('login') }}" class="hidden sm:inline-block rounded-lg px-3 py-2 text-sm font-medium theme-text-secondary hover:theme-bg-tertiary focus-ring">Log in</a>
                        <a href="{{ route('register') }}" class="hidden sm:inline-block rounded-lg bg-button-dynamic px-3.5 py-2 text-sm font-medium text-white hover:opacity-90 focus-ring">Register</a>
                    @else
                        <div class="relative">
